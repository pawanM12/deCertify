...
function StudentDashboard() {
  ...
  const { contract, address, isConnected, signer, loading, error: web3Error } = useWeb3(); // Removed unused connectWallet, web3Loading
  ...
  }, []); // Removed user?.token from dependencies
  ...
  }, [user]); // Kept user as dependency since user.token is used
